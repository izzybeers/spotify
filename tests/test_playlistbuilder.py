...
def test_create_change_remove_reactivate_multibandlikedsongs_playlist():
    ...
    sub_id = add_new_playlist(public = True,
                            user_id = user_id,
    ...
    try:
        ...
        supabase_band_list = supabase_result['band_list'].iloc[0]
        ...
        assert playlist_id in followed_playlists, 'Error: user is not following playlist.'
        ...
        songs_on_playlist = get_songs_on_playlist(playlist_id)
        ...
        update_subscription_band_list(sub_id, new_band_list, liked_songs)
        ...
        new_supabase_band_list = new_supabase_result['band_list'].iloc[0]
        ...
        followed_playlists = get_followed_playlists()
        assert playlist_id in followed_playlists, 'Error: user is not following new playlist.'
        ...
        songs_on_new_playlist = get_songs_on_playlist(playlist_id)
        ...
        update_subscription_band_list(sub_id, new_trimmed_band_list, liked_songs)
        ...
        trimmed_supabase_band_list = trimmed_supabase_result['band_list'].iloc[0]
        ...
        followed_playlists = get_followed_playlists()
        assert playlist_id in followed_playlists, 'Error: user is not following trimmed playlist.'
        ...
        songs_on_trimmed_playlist = get_songs_on_playlist(playlist_id)
        ...
        deactivated_supabase_band_list = deactivated_supabase_result['band_list'].iloc[0]
        ...
        followed_playlists = get_followed_playlists()
        assert playlist_id not in followed_playlists, 'Error: User is still following the deactivated playlist'
        ...
        reactivated_supabase_band_list = reactivated_supabase_result['band_list'].iloc[0]
        ...
        followed_playlists = get_followed_playlists()
        assert playlist_id in followed_playlists, 'Error: user is not following reactivated playlist.'
